...
void setup() {
  ...
  //********** GETTING UV/IR DATA FROM SENSOR (GY-1145) ****************************

  mySI1145.init();

  mySI1145.setMeasurementRate(0x8FF);
  ...
  mySI1145.enableMeasurements(ALSUV_TYPE, AUTO);

  Serial.println("SI 1145 - lux calculation");
  ...
  client.publish("homeassistant/sensor/solarweatherstationTemp/config", "{\"device_class\": \"temperature\", \"name\": \"Temperature\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"°C\", \"value_template\": \"{{ value_json.temperature}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationAhumidity/config", "{\"device_class\": \"humidity\", \"name\": \"Adjusted Humidity\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"%\", \"value_template\": \"{{ value_json.humidity}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationMpressure/config", "{\"device_class\": \"pressure\", \"name\": \"Measured Pressure\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"mbar\", \"value_template\": \"{{ value_json.mespressure}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationRelpressure/config", "{\"device_class\": \"pressure\", \"name\": \"Relative Pressure\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"mbar\", \"value_template\": \"{{ value_json.relpressure}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationVolt/config", "{\"device_class\": \"voltage\", \"name\": \"Battery Voltage\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"V\", \"value_template\": \"{{ value_json.voltage}}\" }", 1);      // ,1 = retained
  delay(50);
  
  client.publish("homeassistant/sensor/solarweatherstationDewpoint/config", "{\"device_class\": \"temperature\", \"name\": \"Dewpoint\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"°C\", \"value_template\": \"{{ value_json.dewpoint}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationHeatindex/config", "{\"device_class\": \"temperature\", \"name\": \"Heat Index\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"°C\", \"value_template\": \"{{ value_json.heatindex}}\" }", 1);      // ,1 = retained
  delay(50);
  
  client.publish("homeassistant/sensor/solarweatherstationAccuracy/config", "{\"device_class\": \"power_factor\", \"name\": \"Accuracy\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"%\", \"value_template\": \"{{ value_json.accuracy}}\" }", 1);      // ,1 = retained
  delay(50);
  
  client.publish("homeassistant/sensor/solarweatherstationDewpointspread/config", "{\"device_class\": \"temperature\", \"name\": \"Dewpoint spread\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"°C\", \"value_template\": \"{{ value_json.dewpointspread}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationZambretti/config", "{\"name\": \"Zambretti says\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"value_template\": \"{{ value_json.zambretti}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationTrendw/config", "{\"name\": \"Trend in words\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"value_template\": \"{{ value_json.trendinwords}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationTrend/config", "{\"name\": \"Trend\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"value_template\": \"{{ value_json.trend}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationVis/config", "{\"device_class\": \"illuminance\", \"name\": \"Measured Illuminance\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"lx\", \"value_template\": \"{{ value_json.vis}}\" }", 1);      // ,1 = retained
  delay(50);
  
  client.publish("homeassistant/sensor/solarweatherstationInfrared/config", "{\"device_class\": \"illuminance\", \"name\": \"Infrared light\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"lx\", \"value_template\": \"{{ value_json.infrared}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationUvindex/config", "{\"device_class\": \"illuminance\", \"name\": \"UV Index\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"value_template\": \"{{ value_json.uvindex}}\" }", 1);      // ,1 = retained
  delay(50);

  client.publish("homeassistant/sensor/solarweatherstationIllu/config", "{\"device_class\": \"illuminance\", \"name\": \"Calculated Illuminance\", \"state_topic\": \"homeassistant/sensor/solarweatherstation/state\", \"unit_of_measurement\": \"lx\", \"value_template\": \"{{ value_json.illuminance}}\" }", 1);      // ,1 = retained
  delay(50);
...
void measurementEvent() {
  ...
  measured_vis = mySI1145.getAlsVisData();
...
float calcLux(uint16_t vis, uint16_t ir) {
  ...
  const unsigned int ir_dark = 252; // empirical value
  ...
  const float visCountPerLux = 0.282; // for sunlight (datasheet https://www.silabs.com/documents/public/data-sheets/Si1145-46-47.pdf)
  const float irCountPerLux = 2.44; // for sunlight (datasheet https://www.silabs.com/documents/public/data-sheets/Si1145-46-47.pdf)
  const float corrFactor = 1.0; // my empirical correction factor
