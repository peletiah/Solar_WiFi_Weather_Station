...
char ssid[] = "saturate";                           // WiFi Router ssid
char pass[] = "moeilijk";             // WiFi Router password

const char* server = "api.thingspeak.com";        // Thingspeak Write API
const char* api_key = "7FJWVB5ISWO5HS4V";         // API write key 

/****** MQTT Settings ********************************************************/

const char* mqtt_server = "10.0.0.30";      // MQTT Server (broker) address
